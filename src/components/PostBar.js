...
class PostBar extends Component{
    render(){
        ...
        <div className="post-topbar">
          ...
          <img src={"./images/"+user?.username +".jpeg"}/>
          </div>
        ...
        {postData.map((post,idx) => <div key={idx} className="post-bar">
          ...
          <div className="job_descp">
            ...
            <ul className="skill-tags">
              {post.skills.map((skl,idx2) => <li key={idx2}><a href="./index.html#" title="">HTML</a></li>)}
            </ul>
          </div>
          <div className="job-status-bar">
            ...
            <a href="./index.html#"
              ><i className="fas fa-eye"></i>{post.viewed_by.length}</a
            >
          </div>
        </div>)}
        </div>
